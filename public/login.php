...
<body>
  <div class="">
    <div class="row">
      ...
      <div class="col-md-5">
        <form action="<?php echo \Src\get_server_url_domain_name(); ?>/public/login.php" method="POST" class="" id="loginForm">
            <fieldset id="loginFormFieldset">
                ...
                <div class="input-field right-align">
                  <input type="submit" id="inputSubmit" class="btn btn-flat btn-small" />
                </div>
                <div>
                ...
                <div id="loginFormRedirect">
                    <a href="<?php echo \Src\get_server_url_domain_name(); ?>/public/auth/password_reset.php" id="loginFormPasswordReset" class="left left-align">Forgot password ?</a>
                    <a href="<?php echo \Src\get_server_url_domain_name(); ?>/public/auth/register.php" id="loginFormRegister" class="right right-align">Create an account.</a>
                </div>
            </fieldset>
        </form>
      </div>
